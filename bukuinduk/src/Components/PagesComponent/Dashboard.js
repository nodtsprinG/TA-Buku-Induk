                ...
                <div className='container w-full h-full rounded-[0_16px_16px_0] border border-gray-100'>
                    ...
                    <nav className='w-fill h-[451px] p-[24px_24px_0_24px] gap-[10px]'>
                        ...
                        <div className='w-[236px] h-[40px] rounded-[8px] p-[10px_12px_10px_12px] gap-[10px] flex items-center hover:bg-gray-100'>
                            ...
                            <button onClick={() => navigate('/admindashboard')} className='font-Quicksand font-bold text-[15px] text-left leading-5'>Dashboard</button>
                        </div>
                        ...
                        <div onClick={() => setIsOpen(!isOpen)} className='relative w-[236px] h-[40px] mt-2 rounded-[8px] p-[10px_12px_10px_12px] gap-[10px] flex items-center justify-between hover:bg-gray-100'>
                            <div className='flex items-center gap-[10px]'>
                                ...
                                <label className='font-Quicksand font-bold text-[15px] text-left leading-5'>Data Siswa</label>
                            </div>
                            ...
                            {isOpen && (
                                <ul className='absolute top-full mt-0 left-0 w-[172px] h-[140px] gap-1 bg-white px-4 py-4'>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button onClick={() => navigate('/semuasiswa')} className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Semua Siswa</button>
                                    </li>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button onClick={() => navigate('/halamandepan')} className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Halaman Depan</button>
                                    </li>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button onClick={() => navigate('/halamanbelakang')} className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Halaman Belakang</button>
                                    </li>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Menu 4</button>
                                    </li>
                                </ul>
                            )}
                        </div>
                        ...
                        <div onClick={() => setIsOpen1(!isOpen1)} className={`relative w-[236px] h-[40px] rounded-[8px] p-[10px_12px_10px_12px] gap-[10px] flex items-center justify-between hover:bg-gray-100 transition-all duration-300 ${isOpen ? 'mt-[160px]' : 'mt-2'}`}>
                            <div className='flex items-center gap-[10px]'>
                                ...
                                <label className='font-Quicksand font-bold text-[15px] text-left leading-5'>Mapel</label>
                            </div>
                            <LiaAngleDownSolid className='w-[15px] h-[15px]' />
                            {isOpen1 && (
                                <ul className='absolute top-full mt-0 left-0 w-[172px] h-[140px] gap-1 bg-white px-4 py-4'>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Menu 1</button>
                                    </li>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Menu 2</button>
                                    </li>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Menu 3</button>
                                    </li>
                                    <li className='w-fill h-[32px] rounded-lg p-[8px_12px_8px_12px] gap-[12px] text-slate-500 hover:bg-gray-100 hover:text-black'>
                                        <button className='flex justify-center items-center font-Quicksand font-bold text-xs tracking-[-0.02em]'>Menu 4</button>
                                    </li>
                        ...
                        <div className={`w-[236px] h-[40px] rounded-[8px] p-[10px_12px_10px_12px] gap-[10px] flex hover:bg-gray-100 transition-all duration-300 ${isOpen1 ? 'mt-[160px]' : 'mt-2'}`}>
                            ...
                            <button className='font-Quicksand font-bold text-[15px] text-left leading-5'>Guru</button>
                        </div>
                    </nav>
