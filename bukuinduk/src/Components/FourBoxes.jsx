...
const FourBoxes = () => {
    return (
        <div className='flex w-full h-full gap-5'>
            ...
            <div className='w-[270px] h-[108px] rounded-xl p-6 gap-2 bg-subcontent'>
                <div className='flex w-[200px] h-[65px]'>
                    ...
                    <div className='w-[130px] h-[65px] flex flex-col justify-center gap-2'>
                        <label className='font-Quicksand font-bold text-sm text-center'>Total Data Siswa</label>
                        <label className='font-Quicksand font-bold text-sm text-center'>1212</label>
                    </div>
                </div>
            </div>
            ...
            <div className='w-[270px] h-[108px] rounded-xl p-6 gap-2 bg-subcontent'>
                <div className='flex w-[200px] h-[65px]'>
                    ...
                    <div className='w-[130px] h-[65px] flex flex-col justify-center gap-2'>
                        <label className='font-Quicksand font-bold text-sm text-center'>Siswa-Siswi Aktif</label>
                        <label className='font-Quicksand font-bold text-sm text-center'>1212</label>
                    </div>
                </div>
            </div>
            ...
            <div className='w-[270px] h-[108px] rounded-xl p-6 gap-2 bg-subcontent'>
                <div className='flex w-[200px] h-[65px]'>
                    ...
                    <div className='w-[130px] h-[65px] flex flex-col justify-center gap-2'>
                        <label className='font-Quicksand font-bold text-sm text-center'>Siswa Laki-Laki</label>
                        <label className='font-Quicksand font-bold text-sm text-center'>1212</label>
                    </div>
                </div>
            </div>
            ...
            <div className='w-[270px] h-[108px] rounded-xl p-6 gap-2 bg-subcontent'>
                <div className='flex w-[200px] h-[65px]'>
                    ...
                    <div className='w-[130px] h-[65px] flex flex-col justify-center gap-2'>
                        <label className='font-Quicksand font-bold text-sm text-center'>Siswa Perempuan</label>
                        <label className='font-Quicksand font-bold text-sm text-center'>1212</label>
                    </div>
                </div>
            </div>
